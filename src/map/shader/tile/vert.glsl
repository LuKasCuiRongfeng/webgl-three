...
void main() {
    ...
    // float v1 = uActiveVertex[0][0];
    // float v2 = uActiveVertex[1][0];
    // float v3 = uActiveVertex[2][0];
    // float v4 = uActiveVertex[3][0];

    // if(gl_VertexID == int(v1) || gl_VertexID == int(v2) ||
    //     gl_VertexID == int(v3) || gl_VertexID == int(v4)) {
    //     csm_Position.xyz += 10.;
    // }
